...
uses
  ...
  unitdmpendaftaran, unitRiwayatPasien, unitFarmasi, unitFarmasiRawatJalan,
  unitFarmasiValidasiResep, unitAiAuditKeluhan;
...
begin
  ...
  Application.CreateForm(TFormAiAuditKeluhan, FormAiAuditKeluhan);
  Application.Run;
end.
